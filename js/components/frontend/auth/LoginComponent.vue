            ...
            <form @submit.prevent="login">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <router-link :to="{ name: 'auth.forgetPassword' }"
                                 class="capitalize text-xs font-medium transition text-heading hover:underline">
                ...
                <div class="flex items-center justify-center gap-2 mb-4">
                    ...
                    <router-link :to="{ name: 'auth.signupPhone' }" class="text-xs font-medium text-heading">
                        {{ $t('button.signup') }}
                    </router-link>
                </div>
                <p class="text-sm uppercase text-center mb-3 text-[#6E7191]">{{ $t('label.or') }}</p>
                <router-link :to="{ name: 'auth.guestLogin' }"
                             class="w-full h-12 leading-[46px] text-center capitalize font-medium rounded-3xl border text-heading border-primary bg-white">
