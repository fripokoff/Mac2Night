<template>
    ...
    <div v-if="design === itemDesignEnum.LIST" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
        <div v-for="item in items" :key="item" v-show="type === null || type === item.item_type" class="_custom-popular-cards product-card-list">
...
<img src="/svg/halal-icon.svg" alt="Halal Icon" class="lab-font-size-16">
                ...
                <div class="product-card-list-footer-group">
                    ...
                    <button @click.prevent="variationModalShow(item)" data-modal="#item-variation-modal"
                        class="_custom-featured-add-to-cart product-card-list-cart-btn add-btn">
    ...
    <div v-else-if="design === itemDesignEnum.GRID" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 lg:gap-6">
        <div v-for="item in items" :key="item" v-show="type === null || type === item.item_type" class="_custom-featured-cards product-card-grid">
...
<img src="/svg/halal-icon.svg" alt="Halal Icon" class="lab-font-size-16">
                ...
                <div class="product-card-grid-footer-group">
                    ...
                    <button @click.prevent="variationModalShow(item)" data-modal="#item-variation-modal"
                        class="_custom-our-menu-add-to-cart product-card-grid-cart-btn add-btn">
                        <i class="lab lab-bag-2 font-fill-primary transition lab-font-size-14"></i>
                        <span class="text-xs text-primary transition">{{ $t('button.add') }}</span>
                    </button>
                </div>
                ...
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div class="flex items-center indec-group py-1 px-2 rounded-xl bg-[#F7F7FC]">
                        <button @click.prevent="quantityDecrement"
                            class="fa-solid fa-minus text-[10px] w-[18px] h-[18px] leading-4 text-center rounded-full border transition text-heading border-primary hover:bg-primary hover:text-white indec-minus"></button>
                        ...
                        <button @click.prevent="quantityIncrement"
                            class="fa-solid fa-plus text-[10px] w-[18px] h-[18px] leading4 text-center rounded-full border transition text-heading border-primary hover:bg-primary hover:text-white indec-plus"></button>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center indec-group">
                                            ...
                                            <input v-on:keypress="onlyNumber($event)" v-on:keyup="addonQuantityUp(addon.id)"
