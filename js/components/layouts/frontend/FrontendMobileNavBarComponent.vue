<template>
    <nav
        ...
        <router-link :class="checkIsPathAndRoutePathSame('/menu') ? 'text-primary' : ''"
            ...
            <i class="fa-solid fa-hamburger text-base leading-none"></i>
            <span class="text-xs capitalize">{{ $t('label.menu') }}</span>
        </router-link>

        <button class="mobcart fa-solid fa-shopping-cart text-base w-12 h-12 leading-[48px] text-center rounded-full -mt-12 text-white bg-primary
        ...
        <a :class="checkIsPathAndRoutePathSame('/offers') ? 'text-primary' : ''"
			class="flex flex-col items-center gap-1"
			href="https://g.page/r/CYMmj1pHvir2EAg/review" target="_blank" rel="noopener noreferrer">
				<i class="fa-solid fa-star text-base leading-none"></i>
				<span class="text-xs capitalize">Avis</span>
			</a>
