<template>
    ...
    <header class="shadow-xs _custom-header ff-header">
        <div class="container flex flex-col lg:flex-row items-center justify-between">
            <div class="w-full flex items-center justify-between gap-5 xl:gap-8 lg:justify-start lg:w-fit">
                ...
                <div class="relative dropdown-group" v-if="branches.length > 1">
                    <button class="flex items-center text-left gap-2 dropdown-btn">
                        ...
                        <i class="lab lab-arrow-down-2 lab-font-size-15 text-xs text-white"></i>
                    </button>
            ...
            <nav class="items-center justify-center gap-6 hidden lg:flex">
                <router-link :to="{ name: 'frontend.home' }"
                    :class="checkIsPathAndRoutePathSame('/home') ? '_custom-navbar-menu-active' : ''"
                    class="capitalize text-sm font-medium _custom-navbar-menu-inactive">
                    {{ $t('menu.home') }}
                </router-link>
                <router-link :to="{ name: 'frontend.menu', query: { s: categoryProps.slug } }"
                    :class="checkIsPathAndRoutePathSame('/menu') ? '_custom-navbar-menu-active' : ''"
                    class="capitalize text-sm font-medium _custom-navbar-menu-inactive">
                    {{ $t('label.menu') }}
                </router-link>
				<!--
            ...
            <div class="flex flex-col items-center justify-end gap-3 w-full mt-4 lg:flex-row lg:w-fit lg:mt-0">
                ...
                <button
                    class="_custom-webcart-button webcart hidden lg:flex items-center justify-center gap-1.5 w-fit rounded-3xl capitalize text-sm font-medium h-8 px-3 transition text-white bg-heading">
        ...
        currencyFormat(subtotal, setting.site_digit_after_decimal_point,
            setting.site_default_currency_symbol, setting.site_currency_position)
                ...
                <router-link v-if="!logged"
                    class="_custom-login-account-button hidden lg:flex items-center justify-center gap-1 w-fit rounded-3xl capitalize text-sm font-medium h-8 px-3 transition text-white bg-primary"
                    :to="{ name: 'auth.login' }">
                ...
                <div v-else class="dropdown-group">
                    <button
                        class="_custom-login-account-button dropdown-btn hidden lg:flex items-center justify-center gap-1 w-fit rounded-3xl capitalize text-sm font-medium h-8 px-3 transition text-white bg-primary">
                        <i class="lab lab-profile-circle"></i>
                        <span class="whitespace-nowrap">{{ $t('label.account') }}</span>
                        <i class="lab lab-arrow-down-2 text-xs ml-1.5 lab-font-size-15"></i>
                    </button>
                    <div
                        class="_custom-account-login-dropdown dropdown-list w-80 absolute top-12 ltr:right-0 rtl:left-0 z-[60] rounded-xl shadow-paper bg-white">
